...
const DUNGEON_TIERS = {
    Easy: {
        ...
        environment: BATTLE_ENVIRONMENTS[2]
    },
    Medium: {
        name: "Sunken Temple",
        floors: 10,
        ...
        environment: BATTLE_ENVIRONMENTS[5]
    },
    Hard: {
        name: "Volcanic Lair",
        floors: 10,
        ...
        environment: BATTLE_ENVIRONMENTS[0]
    },
    Difficult: {
        name: "Void Nexus",
        floors: 10,
        ...
        environment: BATTLE_ENVIRONMENTS[3]
    },
    Extreme: {
        ...
        environment: BATTLE_ENVIRONMENTS[6]
    }
};

const FLOOR_SCALING = {
    "1-2": { multiplier: 0.8, count: 2 },
    "3-4": { multiplier: 1.0, count: 2 },
    "5-6": { multiplier: 1.2, count: 3 },
    "7-8": { multiplier: 1.5, count: 3 },
    "9":   { multiplier: 1.8, count: 4 },
    "10":  { multiplier: 2.5, count: 1 }
};
