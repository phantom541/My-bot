const beasts = [
    {
        ...
        weakness: "Light",
        imageUrl: "https://images.unsplash.com/photo-1575382999375-a6c69b84e649?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3OTY5NTB8MHwxfHNlYXJjaHwxfHxMeWNhZ29uJTIwdGhlJTIwTmlnaHRzbGF5ZXIlMjBmYW50YXN5JTIwYXJ0fGVufDB8fHx8MTc1NjY1NDM0Nnwz&ixlib=rb-4.1.0&q=80&w=1080",
        moves: [
            { name: "Moon Claw", damage: 150, type: "Shadow" },
            { name: "Lunar Drain", damage: 120, type: "Shadow" },
            { name: "Feral Leap", damage: 100, type: "Metal" },
            { name: "Silent Howl", damage: 80, type: "Wind" },
            { name: "Ghost Slash", damage: 180, type: "Shadow" },
            { name: "Crescent Barrage", damage: 50, type: "Metal" },
        ]
    },
    {
        id: 2,
        ...
        weakness: "Fire",
        imageUrl: "https://images.unsplash.com/photo-1585441694812-6f21997b88ee?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3OTY5NTB8MHwxfHNlYXJjaHwxfHxDdGFybmlkZCUyMG9mJTIwdGhlJTIwQWJ5c3MlMjBmYW50YXN5JTIwYXJ0fGVufDB8fHx8MTc1NjY1NDM0N3wz&ixlib=rb-4.1.0&q=80&w=1080",
        moves: [
            { name: "Tentacle Slam", damage: 140, type: "Water" },
            { name: "Abyss Gaze", damage: 90, type: "Shadow" },
            { name: "Water Bind", damage: 110, type: "Ice" },
            { name: "Deep Crush", damage: 160, type: "Water" },
            { name: "Drown Field", damage: 130, type: "Water" },
            { name: "Pressure Shift", damage: 0, type: "Water" },
        ]
    },
    {
        id: 3,
        ...
        moves: [
            ...
            { name: "Cyclone Guard", damage: 0, type: "Wind" },
            { name: "Tailstorm", damage: 140, type: "Wind" },
            { name: "Roar of Ruin", damage: 80, type: "Shadow" },
            { name: "Thunder Dive", damage: 250, type: "Lightning" },
    ...
    },
    {
        ...
        moves: [
            { name: "Mind Shatter", damage: 130, type: "Shadow" },
            { name: "Echo Break", damage: 90, type: "Metal" },
            { name: "Resonance Shield", damage: 0, type: "Metal" },
            { name: "Chime Slash", damage: 160, type: "Metal" },
            { name: "Bass Bomb", damage: 220, type: "Fire" },
            { name: "Song of Silence", damage: 90, type: "Wind" },
        ]
    },
    {
        id: 5,
        ...
        moves: [
            ...
            { name: "Vengeful Wake", damage: 100, type: "Fire" },
            { name: "Blade Cross", damage: 170, type: "Metal" },
            { name: "Soul-Forged Steel", damage: 200, type: "Metal" },
            { name: "Shadowbind", damage: 110, type: "Shadow" },
            { name: "Iron March", damage: 0, type: "Metal" },
        ]
    },
    {
        id: 6,
        ...
        moves: [
            ...
            { name: "Rot Spore", damage: 100, type: "Shadow" },
            { name: "Digest", damage: 120, type: "Water" },
            { name: "Jungle Cry", damage: 0, type: "Wind" },
    ...
    },
    {
        ...
        moves: [
            ...
            { name: "Fade", damage: 0, type: "Shadow" },
            { name: "Reality Warp", damage: 150, type: "Metal" },
            { name: "Void Tear", damage: 130, type: "Shadow" },
            { name: "Whisper End", damage: 110, type: "Shadow" },
